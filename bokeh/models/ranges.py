...
class Range1d(Range):
    ...
    start = Either(Float, Datetime, TimeDelta, Int, default=0, help="""
    The start of the range.
    """)

    end = Either(Float, Datetime, TimeDelta, Int, default=1, help="""
    The end of the range.
    """)

    reset_start = Either(Float, Datetime, TimeDelta, Int, default=None, help="""
    The start of the range to apply after reset. If set to ``None`` defaults
    to the ``start`` value during initialization.
    """)

    reset_end = Either(Float, Datetime, TimeDelta, Int, default=None, help="""
